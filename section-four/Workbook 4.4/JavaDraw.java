...
public class JavaDraw {
    ...
    public static void draw(int choice) {
        switch(choice) {
            case 1: animalOne(); break;
            case 2: animalTwo(); break;
            case 3: animalThree(); break;
            case 4: animalFour(); break;
            default: System.out.println("That was not an option."); break;
        }
    }
     
     
    public static void animalOne() {
    ...
    public static void animalThree() {
