...
public class Blackjack {
    ...
    public static void main(String[] args) {
        ...
        int dealerValue = dealerCard + facedownCard;
        ...
        System.out.println("\nThe dealer's total is: " + dealerValue);
        System.out.println("\nPress enter to continue.");
        scan.nextLine();
        while (dealerValue < 17) {
            ...
            dealerValue += newCard;
            System.out.println("\nThe dealer draws\n" + cardString(newCard));
            System.out.println("\nThe dealer's new total is: " + dealerValue);
            if (dealerValue > 21) {
        ...
        if (handValue > dealerValue) {
            System.out.println("\nYour total is: " + handValue + ". The dealer's total is: " + dealerValue);
            System.out.println("\nYou win!");
        } else {
            System.out.println("\nYour total is: " + handValue + ". The dealer's total is: " + dealerValue);
